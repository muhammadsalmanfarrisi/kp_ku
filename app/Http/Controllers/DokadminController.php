...
class DokadminController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('dokadmin.index', compact('data_dokumen'));
    }
    public function create(): View
    {

        return view('dokadmin.create');
    }
    ...
    public function show(string $id): View
    {
        ...
        return view('dokadmin.show', compact('data_dokumen'));
    }
    ...
    {
        $data_dokumen = Dokumen::findOrFail($id);
        return view('dokadmin.edit', compact('data_dokumen'));
    }
