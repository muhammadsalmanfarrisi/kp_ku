...
<div class="traffice-source-area mg-b-30">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"><a href="{{ route('kelola-user.index') }}">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"><a href="{{ route('katadmin.index') }}">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"><a href="{{ route('dokadmin.index') }}">
                <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"><a href="{{ route('instansi.index') }}">
                <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"><a href="{{ route('cabang.index') }}">
                <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"><a href="{{ route('unit.index') }}">
                <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"><a href="{{ route('produk.index') }}">
                <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
