...
<body>
    ...
    <div class="container mt-5 bg-info-subtle">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h3 class="text-center my-4">Menampilkan Unit</h3>
                    <hr>
                </div>
                &nbsp;&nbsp;&nbsp;
                               
                <a href="{{ route('cabang.index') }}" class="btn btn-sm btn-danger">KEMBALI</a> <br> <br>
                
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('unit.create') }}" class="btn btn-sm btn-primary">TAMBAH UNIT</a> <br> <br>
